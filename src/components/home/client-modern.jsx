  ...
  return (
    <section id="clients-section" ref={sectionRef} className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        {/* Testimonial section */}
        <motion.div 
          className="mt-16 bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8"
          initial={{ opacity: 0, y: 30 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
        ...
        >
          <div className="flex flex-col md:flex-row items-center">
            <div className="mb-6 md:mb-0 md:mr-8 flex-shrink-0">
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden border-4 border-indigo-100">
                <Image 
                  src="/assets/imgs/partners/testimonial-avatar.jpg" 
            ...
            <div>
              ...
              <p className="text-gray-600 italic mb-4 text-lg">
                "TechInfraEdge has been an invaluable partner in our digital transformation journey. Their team's expertise and dedication have helped us achieve remarkable results."
              </p>
              <div>
                <h4 className="font-bold text-gray-800">Sarah Johnson</h4>
                <p className="text-gray-500">CTO, Global Innovations Inc.</p>
              </div>
            </div>
          </div>
        </motion.div>
