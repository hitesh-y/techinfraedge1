...
export default function HeaderTCSHover() {
                            ...
                            <ul className="flex space-x-8">
                                {mainNavItems.map((item, index) => (
                                    <li key={index} className="relative group z-50">
                                        ...
                                        {item.hasDropdown && (
                                            <div 
                                                className="absolute left-0 top-full w-full bg-white shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 z-50"
