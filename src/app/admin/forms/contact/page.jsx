...
export default function ContactFormsPage() {
  ...
  const fetchForms = async () => {
    try {
      setIsLoading(true)
      const response = await fetch('/api/forms?type=contact')
      if (response.ok) {
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-400 mt-1">Manage and respond to contact form inquiries</p>
      </div>
                  ...
                  {filteredForms.map((form, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm text-gray-300 truncate max-w-xs">{form.subject}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                ...
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="bg-gray-750 p-3 rounded-md text-white">{selectedForm.subject}</div>
                    </div>
